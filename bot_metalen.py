...
def check_live_signaal(df, s, t, ticker):
    ...
    # Directe link naar Yahoo Finance voor snelle check
...
def bereken_bt(df, inzet, s, t):
    # Kosten voor buitenlandse beurzen (NYSE/TSX) bij Bolero
    VASTE_KOST = 15.00 
    BEURSTAKS_PCT = 0.0035 # Standaard taks buitenlandse aandelen
...
def main():
    stuur_telegram("🥇🥈🥉 *START: METALEN ANALYSE (BOLERO READY)*")
    ...
    # Berekening startkapitaal minus actieve posities
    ...
    if live:
        ...
        rapport += "😴 *Geen actie vereist voor Goud, Zilver of Koper.*"
