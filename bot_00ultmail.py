...
# CORE ENGINE
# ---------------------------------------------------------------------------
def voer_lijst_uit(bestandsnaam: str, label: str, naam_sector: str) -> str:
    ...
    # Geef volledige tekst terug voor e-mail verzameling
    volledige_tekst = "\n".join(deel1) + "\n\n" + "\n".join(deel2)
...
def main():
    ...
    verzamel_rapport = "🚀 *FULL GLOBAL SCAN COLLECTIVE REPORT (BOT 00 ULT)*\n" + "=" * 30 + "\n\n"
    ...
    # Verzend verzamelrapport per e-mail
    datum_vandaag = datetime.now().strftime("%d-%m-%Y")
    stuur_mail(f"Trading Rapport Bot 00 Ult: {datum_vandaag}", verzamel_rapport)
